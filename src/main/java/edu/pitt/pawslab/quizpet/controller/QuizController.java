...
public class QuizController {
	...
	@RequestMapping(value = "/injectConcept/{quizId}", method = RequestMethod.GET)
	public @ResponseBody ServerMessage injectConcept(@PathVariable Integer quizId) throws Exception{
		logger.info("injecting concepts for quiz id: " + quizId, locale);
		return conceptService.injectConceptForOneQuiz(quizId);
	}
}
